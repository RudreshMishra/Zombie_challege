...
#plt.hist(filtered_elevation.ravel(), normed=1, histtype='bar', color=colors, label=colors)
#colors = ['red', 'tan', 'lime']
#plt.hist(filtered_elevation, 10, normed=1, histtype='bar')
